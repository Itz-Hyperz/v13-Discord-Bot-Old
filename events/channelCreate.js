...
module.exports = async(client, con, channel) => {
        ...
        if(client.config.logging_module.channelCreate) {

            client.config.logging_module.channelCreateChannels.forEach(async chan => {
                ...
                if(!thechannel) {
                    ...
                    .setColor(`${client.config.logging_module.channelCreateColorhex || client.config.colorhex}`)
